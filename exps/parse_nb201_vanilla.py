...
def compute_diswot_procedure(sample_number=50,
                             TARGET='cifar10',
                             NUM_CLASSES=10):
    if TARGET == 'cifar100':
...
def main_kd_zc(TARGET, NUM_CLASSES):
    ...
    for loss_name in loss_name_list:
        ...
        for _ in range(times):
            ...
            #     print(f'=======> Error info: {e} of loss: {loss_name}')
        print(f'LOSS: {loss_name} LIST: {every_time_sp} TIME COST: {(time.time() - t1)/times}')
        loss_dict[loss_name] = {
            'kd': every_time_kd,
            'sp': every_time_sp,
            'ps': every_time_ps,
    ...
    # with open(f'./zc_name-result_x10_{TARGET}.txt', 'w') as f:
...
if __name__ == '__main__':
    ...
    res_list = []
    for _ in range(5):
        res_list.append(compute_diswot_procedure(50, TARGET, NUM_CLASSES))
    print(res_list)
    print(f'======> {(time.time() - t1)/5}')
    ...
    # result_list = []
    # for i in range(5):
    #     result_list.append(compute_diswot_procedure(train_loader))
    # print(result_list)
