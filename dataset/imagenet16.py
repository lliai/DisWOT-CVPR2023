...
class ImageNet16(data.Dataset):
    ...
    def __init__(self, root, train, transform, use_num_of_class_only=None):
        ...
        for _, (file_name, checksum) in enumerate(downloaded_list):
...
def get_imagenet16_dataloaders(root=None, batch_size=128, num_workers=4):
    if root is None:
    ...
    train_set = ImageNet16(root=root,
                           train=True,
                           transform=train_transform,
                           use_num_of_class_only=120)
    val_set = ImageNet16(root=root,
                         train=False,
