...
class tresnet110(nn.Module):
    def __init__(self, num_classes):
        super(tresnet110, self).__init__()
        self.conv1 = nn.Conv2d(3,
                               16,
                               kernel_size=3,
                               stride=1,
    ...
    def make_layer(self, block, num, in_channels,
                   out_channels):  # num must >=2
    ...
    def forward(self, x, is_feat=False, preact=False):
        ...
        if is_feat is True:
            return [stem[1], rb1[1], rb2[1], rb3[1], feat], out
        else:
            return out
    ...
    def get_chw_num(self):
        return [(16, 32, 32), (16, 32, 32), (32, 16, 16), (64, 8, 8), (64, ),
                (self.num_class, )]
