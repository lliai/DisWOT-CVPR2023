...
from models.candidates.mutable.SuperResK1KXK1 import (SuperResK1K3K1,
                                                      SuperResK1K5K1,
                                                      SuperResK1K7K1)
...
def get_select_student_channels_list(out_channels):
    the_list = [
        out_channels * 2.5, out_channels * 2, out_channels * 1.5,
        out_channels * 1.25, out_channels, out_channels / 1.25,
        out_channels / 1.5, out_channels / 2, out_channels / 2.5
    ]
